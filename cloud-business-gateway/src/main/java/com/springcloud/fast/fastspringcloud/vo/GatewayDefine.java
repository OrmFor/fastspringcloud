package com.springcloud.fast.fastspringcloud.vo;
...
public class GatewayDefine {
    ...
    private JSONArray filterDefinition;
    private JSONArray predicateDefinition;

    public void setFilterDefinition(JSONArray filterDefinition) {
        this.filterDefinition = filterDefinition;
    }

    public void setPredicateDefinition(JSONArray predicateDefinition) {
